...
static PyObject *__pyx_pw_17cython_util_funcs_1get_crater_diams(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("get_crater_diams (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_crater_ids)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("get_crater_diams", 1, 4, 4, 1); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_crater_ids_arr)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_crater_diams", 1, 4, 4, 2); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_total_craters)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_crater_diams", 1, 4, 4, 3); __PYX_ERR(0, 11, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_crater_diams") < 0)) __PYX_ERR(0, 11, __pyx_L3_error)
      }
    ...
    __pyx_v_total_craters = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_total_craters == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_crater_diams", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 11, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cython_util_funcs.get_crater_diams", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_crater_diam_m_arr), __pyx_ptype_5numpy_ndarray, 1, "crater_diam_m_arr", 0))) __PYX_ERR(0, 11, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_crater_ids), __pyx_ptype_5numpy_ndarray, 1, "crater_ids", 0))) __PYX_ERR(0, 11, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_crater_ids_arr), __pyx_ptype_5numpy_ndarray, 1, "crater_ids_arr", 0))) __PYX_ERR(0, 12, __pyx_L1_error)
...
static PyObject *__pyx_pf_17cython_util_funcs_get_crater_diams(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_crater_diam_m_arr, PyArrayObject *__pyx_v_crater_ids, PyArrayObject *__pyx_v_crater_ids_arr, int __pyx_v_total_craters) {
  ...
  __pyx_pybuffernd_crater_ids_arr.rcbuffer = &__pyx_pybuffer_crater_ids_arr;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_crater_diam_m_arr.rcbuffer->pybuffer, (PyObject*)__pyx_v_crater_diam_m_arr, &__Pyx_TypeInfo_nn___pyx_t_17cython_util_funcs_DTYPE_t1, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 11, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_crater_ids.rcbuffer->pybuffer, (PyObject*)__pyx_v_crater_ids, &__Pyx_TypeInfo_nn___pyx_t_17cython_util_funcs_DTYPE_t2, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 11, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_crater_ids_arr.rcbuffer->pybuffer, (PyObject*)__pyx_v_crater_ids_arr, &__Pyx_TypeInfo_nn___pyx_t_17cython_util_funcs_DTYPE_t2, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 11, __pyx_L1_error)
  }
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_total_craters); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s_DTYPE1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 14, __pyx_L1_error)
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_where); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 22, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_current_id); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 22, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = PyObject_RichCompare(((PyObject *)__pyx_v_crater_ids_arr), __pyx_t_1, Py_EQ); __Pyx_XGOTREF(__pyx_t_2); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 22, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = NULL;
    ...
    if (!__pyx_t_1) {
      ...
      #endif
      {
        ...
        __pyx_t_2 = 0;
        __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_10, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 22, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = __Pyx_GetItemInt(__pyx_t_3, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 22, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_9 = __Pyx_PyInt_As_int(__pyx_t_4); if (unlikely((__pyx_t_9 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 22, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_v_current_id_idx = __pyx_t_9;
 ...
 *     return crater_diams
 */
    __pyx_t_11 = __pyx_v_current_id_idx;
    __pyx_t_9 = -1;
    if (__pyx_t_11 < 0) {
      __pyx_t_11 += __pyx_pybuffernd_crater_diam_m_arr.diminfo[0].shape;
      if (unlikely(__pyx_t_11 < 0)) __pyx_t_9 = 0;
    } else if (unlikely(__pyx_t_11 >= __pyx_pybuffernd_crater_diam_m_arr.diminfo[0].shape)) __pyx_t_9 = 0;
    if (unlikely(__pyx_t_9 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_9);
    ...
    __pyx_t_9 = -1;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_pybuffernd_crater_diams.diminfo[0].shape;
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_9 = 0;
    } else if (unlikely(__pyx_t_12 >= __pyx_pybuffernd_crater_diams.diminfo[0].shape)) __pyx_t_9 = 0;
    if (unlikely(__pyx_t_9 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_9);
      __PYX_ERR(0, 24, __pyx_L1_error)
    }
    *__Pyx_BufPtrStrided1d(__pyx_t_17cython_util_funcs_DTYPE_t1 *, __pyx_pybuffernd_crater_diams.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_crater_diams.diminfo[0].strides) = (*__Pyx_BufPtrStrided1d(__pyx_t_17cython_util_funcs_DTYPE_t1 *, __pyx_pybuffernd_crater_diam_m_arr.rcbuffer->pybuffer.buf, __pyx_t_11, __pyx_pybuffernd_crater_diam_m_arr.diminfo[0].strides));
  }
 ...
 * 
 */
  __pyx_tuple__10 = PyTuple_Pack(8, __pyx_n_s_crater_diam_m_arr, __pyx_n_s_crater_ids, __pyx_n_s_crater_ids_arr, __pyx_n_s_total_craters, __pyx_n_s_crater_diams, __pyx_n_s_i, __pyx_n_s_current_id, __pyx_n_s_current_id_idx); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(4, 0, 8, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cython_util_funcs_pyx, __pyx_n_s_get_crater_diams, 11, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_17cython_util_funcs_1get_crater_diams, NULL, __pyx_n_s_cython_util_funcs); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_get_crater_diams, __pyx_t_1) < 0) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
